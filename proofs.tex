...
\end{itemize}
We represent Gödel's $\beta$ function as e.g., in \cite{mendelson1997introduction} - as a formula $\beta_P(a,b,c,d)$.
...
\begin{itemize}
    \item $\mathit{lookup}(M, l, n, y) = \beta_P(a_{l}, b_{l}, n, \alpha(y))$ if $l$ is a variable of sort $\mathit{Cfg}^*$ and $(l, a_{l}, b_{l}) \in M$;
