...
\begin{proof}[Proof of \Cref{lem:flatten}]
    ...
    \begin{proofenv}
        ...
        $(\mathcal{T}^*, C, \rho) \vDash \mathit{mkList}(Y_1,\ldots,Y_k)$
        and for any $j \in \{ 1, \ldots, k \}$,
        $(\mathcal{T}^*, C, \rho) \vDash (\varphi_j^{\square})[Y_j/\square] \land P$ \, ,
    \end{proofenv}
    ...
    \begin{proofenv}
        ...
        \begin{itemize}
            \item there exist configurations $c_1, \ldots, c_k \in \mathcal{T}_{\mathit{Cfg}}$ such that
                    ...
                    satisfying $\rho^{\prime\prime}(Y_j) = \rho(Y_j)$ for any $j \in \{ 1, \ldots, k \}$,
...
\begin{enumerate}
    ...
    \end{proofenv}
    in other words (by \Cref{def:matchinglogic}),
    \begin{proofenv}
        there exists some $\mathcal{T}^*$-valuation $\rho^\prime$
        satisfying $\rho^\prime(v) = \rho(v)$ for every $v \in \mathit{Var}^* \setminus \vec{Y}$
        such that
        \begin{itemize}
            \item $(\mathcal{T}^*, [c^\prime_1,\ldots,c^\prime_k], \rho^\prime) \vDash \mathit{mkList}(\phi_1,\ldots,\phi_k)$;
            \item $(\mathcal{T}^*, [c^\prime_1,\ldots,c^\prime_k], \rho^\prime) \vDash P^\prime$; and
            \item $(\mathcal{T}^*, [c^\prime_1,\ldots,c^\prime_k], \rho^\prime) \vDash P^\prime_1$ and \ldots \and 
                  $(\mathcal{T}^*, [c^\prime_1,\ldots,c^\prime_k], \rho^\prime) \vDash P^\prime_k$.
        \end{itemize}
    \end{proofenv}
