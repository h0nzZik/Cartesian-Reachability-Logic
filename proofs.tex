...
\begin{definition}[All-Path CRL semantics]\label{def:apCRLsemantics}
    ...
    then for all complete $\Rightarrow_{\mathcal{S}}$-paths $\pi_1,\ldots,\pi_k$
...
Let $pi_1$ be some finite and complete path $\gamma_1 = \gamma_1^1,\gamma_1^2,\ldots,\gamma_1^{l_1}$
and \ldots and $pi_k$ be some finite and complete path $\gamma_k = \gamma_k^1,\gamma_k^2,\ldots,\gamma_k^{l_k}$.
