...
\begin{enumerate}
    ...
    \end{proofenv}
    Let $\rho_2$ be such valuation \jt{What??} (satisfying $\rho_2(v) = \rho_1(v)$ for any $v \in \mathit{Var} \setminus (\vec{X} \cup \vec{Y})$).
    ...
    \begin{enumerate}
        ...
        \end{equation*}
    \end{enumerate}
    where $\mathit{\vec{T}} = \vec{Y},\vec{Y}_1,\ldots,\vec{Y}_k$.
    \end{proofenv}
    We let $\rho_0^\prime$ be defined by $\rho_0^\prime(v) = \rho(v)$ for any $v \in \mathit{Var}$,
    and $i_i := i_1,\ldots,i_k := i_k$.
    By \Cref{lem:mkListSemantics}, the goal changes to
    \begin{proofenv}
    \begin{enumerate}
        \item $(\mathcal{T}, c_1^\prime, )$
    \end{enumerate}
    \end{proofenv}
