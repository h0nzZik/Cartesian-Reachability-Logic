...
\begin{enumerate}
    ...
    \item A matching logic \emph{semantics} is given by means of
          ...
          \begin{itemize}
              \item $(\mathcal{T}, \gamma, \rho) \vDash t_1 = t_2$ iff $\rho(t_1) = \rho(t_2)$, where $t_1,t_2 \in T_{\Sigma, s}(\mathit{Var})$ (for some sort $s$);
...
\begin{proof}
    ...
    \begin{equation*}
        (\mathcal{T}, \gamma, \rho_1) \vDash \varphi \iff (\mathcal{T}, \gamma, \rho_2) \vDash \varphi
    \end{equation*}
    for any $\gamma$;
    and have to prove that
    %\begin{proofenv}
        there exists some $\rho_3$ such that (1) $\rho_3(y) = \rho(y)$ for all $y \in \mathit{Var} \setminus \{ x \}$,
        (2) $\rho_3(x) \in \mathcal{T}_s$, and (3) $(\mathcal{T}, \gamma, \rho_3) \vDash \varphi$,
        if and only if
        there exists some $\rho_4$ such that (4) $\rho_4(y) = \rho^\prime(y)$ for all $y \in \mathit{Var} \setminus \{ x \}$,
        (5) $\rho_4(x) \in \mathcal{T}_s$, and (6) $(\mathcal{T}, \gamma, \rho_4) \vDash \varphi$.
    %\end{proofenv}
