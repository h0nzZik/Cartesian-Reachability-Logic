...
of \emph{monotonicity} stating, intuitively: with growing input $x$, the resulting $y$ also grows.
...
that is greater than $1$.  In this example, the suformula
...
Each reachability system naturally induces a \emph{trasition system}
