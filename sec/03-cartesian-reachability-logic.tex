...
and $k$ target configurations matching $\varphi'_i$s. Additionally, a FOL
...
To achieve that, it is no enough to 
just lift RL rules to tuple-context. And it is not entirely obvious how
to support lockstep reasoning involving construct with repetitive behaviour: in
