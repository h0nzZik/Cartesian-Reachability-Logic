...
\begin{figure}
    ...
    \begin{align*}
    & \prftree[l]{Reduce}
      { \mathcal{S}^* \vDash_\RL (\mathit{cfgconcat}(\ldots \mathit{cfgconcat}(\mathit{cfgitem}(\varphi_1), \mathit{cfgitem}(\varphi_2) )\ldots \mathit{cfgitem(\varphi_k)}) ) \Rightarrow^\forall \bigvee E}
