...
\begin{abstract}
  ...
  Cartesian Reachabiliy Logic, a proper extesion of Reachability logic.
  ...
  given by Reachability logic rules. (Examples of such languages include e.g. C.)
  % TODO - add other  examples of  such languages, including smart contracts
