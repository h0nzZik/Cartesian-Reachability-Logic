...
%    \end{align*}
    ...
    & \prftree[l]{Abstract}
      { \prfStackPremises
        ...
        {(\mathcal{T}, S) \vdash_\CRL \exists \vec{Y}.\, \Phi \Downarrow_{C, E} \Psi^\prime}
      }
      {(\mathcal{T}, S) \vdash_\CRL \exists X, \vec{Y}.\, \Phi \Downarrow_{C, E} \Psi^\prime}
    \end{align*}
...
\begin{enumerate}
    ...
    \item If the proof ends with \emph{Abstract}, TODO.
    \end{enumerate}
\end{proof}
