...
\begin{lemma}[Exactly one component makes step]\label{lem:exactlyOneComponentMakesStep}
    Let $\mathcal{S} = (\mathcal{T}, S)$ be a reachability system over $(\Sigma, \mathit{Cfg})$.
    ...
    \begin{itemize}
        \item $C[i] \Rightarrow_{\mathcal{S}} C^\prime[i]$; and
        \item for every $i^\prime \in \mathbb{N}$ such that $i^\prime \not = i$,
