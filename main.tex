...
\begin{enumerate}
    ...
    and $\Psi = (\varphi_1,\ldots,\varphi_k) \land \varphi$
    and $\Psi^\prime = (\varphi_1^\prime,\ldots,\varphi_k^\prime) \land \varphi^\prime$
    and assume (i) that
    \begin{proofenv}
    ...
    and for any valuation $\rho : \Var \to \mathcal{T}^*$
    such that $(\mathcal{T}^*, C, \rho) \vDash \varphi$,
    ...
    \begin{enumerate}
        ...
        \item We prove the premise of the assumption (i): that $(\mathcal{T}, c_1, \rho) \vDash \varphi_1 \land \varphi$
        and \ldots and $(\mathcal{T}, c_k, \rho) \vDash \varphi_k \land \varphi$.
