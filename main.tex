...
iff there exists $c_1, \ldots, c_k \in \Tcfg$ and $\rho^\prime : \mathit{Var} \to \mathcal{T}$ such that
$\rho^\prime(v) = \rho(v)$ for any $v \in \mathit{FV}(\mathit{mkList}(\phi_1, \ldots, \phi_k))$,
$C = [c_1, \ldots, c_k]$,
and $(\mathcal{T}, c_1, \rho^\prime) \vDash \phi_1$ and \ldots and $(\mathcal{T}, c_k, \rho^\prime) \vDash \phi_k$.
\end{lemma}
\begin{proof}
Admitted.
\end{proof}
