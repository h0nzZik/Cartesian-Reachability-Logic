...
and $(\gamma_k,\rho) \vDash \varphi_l \land \varphi$,
then there exists a $k$-tuple of paths $(\pi_1, \ldots, \pi_k)$
and a $k$-tuple of indices $(i_i, \ldots, i_k)$
such that
$\gamma_1 = \pi_1(0)$ and \ldots and $\gamma_k = \pi_k(0)$,
and
