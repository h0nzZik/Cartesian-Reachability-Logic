...
The technique developed in \cite{BeutnerF22} works on the level of symbolic transition systems (STS),
and in order to verify programs, they have to be first somehow translated into STSs.
On the other hand, Cartesian Hoare logic works on the source-code level - but only of a particular programming language.
