...
[c_1,\ldots,c_k] \Rightarrow_{\mathcal{S}^*} [c_1, \ldots, c_{i-1}, c^\prime, c_{i+1}, \ldots, c_k]    
\end{equation*}
iff (by \Cref{def:basics}) there exists a rule $\varphi \Rightarrow^\exists \varphi^\prime \in S^*$
and valuation $\rho : \mathit{Var} \to \mathcal{T}^*$ such that
$([c_1,\ldots,c_k], \rho) \vDash \varphi$
and $([c_1, \ldots, c_{i-1}, c^\prime, c_{i+1}, \ldots, c_k], \rho) \vDash \varphi^\prime$,
iff (by
...
and valuation $\rho : \mathit{Var} \to \mathcal{T}^*$ such that
\begin{equation*}
    ([c_1,\ldots,c_k], \rho) \vDash \exists \vec{X}.\, \bigvee_{l=1}^{m}(\mathit{cfgheat}(L, \phi_l, R) \land P_l)
\end{equation*}
and
\begin{equation*}
    ([c_1, \ldots, c_{i-1}, c^\prime, c_{i+1}, \ldots, c_k], \rho) \vDash
...
satisfying $\forall y \in \mathit{Var} \setminus X.\, \rho^\prime(y) = \rho(\prime)$
and $\forall y \in \mathit{Var} \setminus y.\, \rho^{\prime\prime}(y) = \rho(\prime)$,
and there exists some $l,j$ satisfying $1 \leq l \leq m$ and $1 \leq j \leq n$ such that
$\rho^\prime \vDash P_l$ and $\rho^{\prime\prime} \vDash P_j$ and
\begin{equation*}
    ([c_1,\ldots,c_k], \rho^\prime) \vDash \mathit{cfgheat}(L, \phi_l, R)
\end{equation*}
and
\begin{equation*}
    ([c_1, \ldots, c_{i-1}, c^\prime, c_{i+1}, \ldots, c_k], \rho^{\prime\prime}) \vDash
...
and there exists some $l,j$ satisfying $1 \leq l \leq m$ and $1 \leq j \leq n$ such that
\begin{itemize}
    \item $\rho^\prime \vDash P_l$; and
    \item $\rho^{\prime\prime} \vDash P_j$; and
    \item $[c_1,\ldots,c_k] = \rho^\prime(L) ++ [\rho^\prime(\phi_l)] ++ \rho^\prime(R)$; and
    \item $[c_1, \ldots, c_{i-1}, c^\prime, c_{i+1}, \ldots, c_k] = \rho^{\prime\prime}(L) ++ [\rho^{\prime\prime}(\phi_j)] ++ \rho^{\prime\prime}(R)$.
\end{itemize}
Now, TODO.
\end{proof}
\begin{proof}
